		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7">
					...
					<h2>Guruku Online</h2>
					<p>Orang bijak belajar ketika mereka bisa. Orang bodoh belajar ketika mereka terpaksa</p>
					<div class="hero-author">
						<div class="hero-author-pic set-bg" data-setbg="img/hero-author.jpg"></div>
						<h5>By Indra Ghopinda, <span>Teknik Informatika UNIKAMA</span></h5>
				...
				<div class="course-item">
					...
					<div class="course-content">
						...
						<div class="seller-info">
							...
							<h6>By Ali Sadikin S.Pd, <span>Guru Bahas Inggris</span></h6>
						</div>
					</div>
				</div>
				<!-- course -->
